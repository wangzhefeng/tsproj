...
class MIC(nn.Module):
    ...
    def __init__(self, feature_size = 512, n_heads = 8, dropout = 0.05, decomp_kernel = [32], 
        ...
        self.merge = nn.Conv2d(in_channels = feature_size, out_channels = feature_size, kernel_size = (len(self.conv_kernel), 1))
        # feedforward network
...
class SeasonalPrediction(nn.Module):
    ...
    def __init__(self, embedding_size = 512, n_heads = 8, dropout = 0.05, 
                 d_layers = 1, decomp_kernel = [32], c_out = 1,
