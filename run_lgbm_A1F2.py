...
logger.info(f"data_loader.data_dir: {data_loader.data_dir}")
...
if sys.platform == "win32":
    data_save_path = f"{ROOT}\\dataset\\electricity\\A1F2\\collect_data"
else:
    data_save_path = f"{ROOT}/dataset/electricity/A1F2/collect_data"
...
logger.info(f"room_cabinet_row_cabinet_names: \n{room_cabinet_row_cabinet_names}")
...
def cabinet_power_forecast(server_data: Dict = None):
    ...
    Args:
        server_data (pd.DataFrame, optional): 服务器功率预测信息. Defaults to None.
    """
