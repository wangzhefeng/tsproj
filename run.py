...
def main():
    ...
    parser.add_argument('--checkpoints', type = str, default = './saved_models/checkpoints/', 
    ...
    parser.add_argument('--train_epochs', type = int, default = 2, help = 'train epochs')  # TODO 10
